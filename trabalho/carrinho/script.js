...
function calcularTotal(){
    var selectnike = document.getElementById("selectnike");
    var selectadidas = document.getElementById("selectadidas");
    var selectous = document.getElementById("selectous");
    var selectallstar = document.getElementById("selectallstar");
    var selectvans = document.getElementById("selectvans");
    ...
    switch (selectnike.value){
        ...
        case "sb":
            ...
            break;
        case "jordanlow":
            total += 1119.99; // Corrigido de 1.119,99 para 1119.99
            nike = 1119.99; // Corrigido de 1.119,99 para 1119.99
            break;
    }
    ...
    switch (selectvans.value){ // Corrigido de select para selectvans
        case "knu":
            total += 599.99;
            vans = 599.99;
            break;
...
function limpar(){
    ...
    document.getElementById("resultado").textContent = ""; // Corrigido de value para textContent
...
function enviarWhatsApp(){
    var nome = document.getElementById("nomePrint").textContent;
    var total = document.getElementById("resultado").textContent;
    var mensagem = "Olá, sou " + nome + " e gostaria de fazer o pedido:\nTotal: " + total;
    var numerotelefone = "5541920004260"
    var link = "https://wa.me/?text=" + numerotelefone + encodeURIComponent(mensagem);
